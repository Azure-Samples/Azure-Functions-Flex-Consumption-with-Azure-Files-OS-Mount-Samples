...
# Decision: User Directive — SMB Authentication Constraint

**Date:** 2026-03-11T00:10:09Z  
**By:** Thiago Almeida (via Copilot)  
**Status:** Captured

## Summary

SMB data plane access to Azure Files does not work with managed identity yet. The tutorial incorrectly stated that managed identity with "Storage File Data SMB Share Contributor" role is sufficient. This constraint has been corrected in all tutorial and quickstart documentation.
