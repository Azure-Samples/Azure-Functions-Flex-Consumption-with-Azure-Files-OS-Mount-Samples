...
|-----------|----------|----------|
| Azure Functions code, samples, Durable Functions | Kaylee | Write function apps, orchestrations, host.json config, mount setup |
| Documentation, tutorials, READMEs | Inara | Write tutorials, gallery listings, quickstarts, update Azure docs |
| Architecture, sample design, scope | Mal | Project structure decisions, what scenarios to cover, trade-offs |
| Code review | Mal | Review PRs, check quality, suggest improvements |
| Testing | Zoe | Write tests, find edge cases, verify samples work end-to-end |
